# 🧮 Prisma CPA — AI Agent Assistant Dashboard

<p align="center">
  <strong>Malta Tax / Audit / Accounting Assistant</strong>
</p>
...
**Prisma CPA** is an _AI Agent Assistant Dashboard_ for Malta tax, audit, and accounting professionals.
It provides VAT return preparation, bank reconciliation, evidence management, audit workpapers, and AML compliance support.
Built on the OpenClaw personal AI assistant platform, it connects via WhatsApp, Telegram, Slack, Discord, and other channels.

> **Important Safety Guardrails:**
> - Never auto-files to CFR Malta portal (human must submit)
> - Never auto-pays taxes or obligations
> - Never auto-posts journals to any General Ledger
> - All official artifacts require maker-checker approval
